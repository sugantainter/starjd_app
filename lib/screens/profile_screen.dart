...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    // Refresh auth status to get latest profile data
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildProfileOption(
                      ...
                      onTap: () async {
                        if (_userData != null) {
                          // For professionals, we can use the specialized edit screen if we want, 
                          // but EditProfileScreen handles most basic fields.
                    ...
                    if (role == 'studio_owner') ...[
                      ...
                      _buildProfileOption(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const StudioOwnerDashboardScreen())),
                      ),
                      _buildProfileOption(
                        context,
                        icon: Icons.storefront_outlined,
                        title: 'Manage My Studios',
                    ...
                    if (role == 'professional') ...[
                      ...
                      _buildProfileOption(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ProfessionalDashboardScreen())),
                      ),
                      _buildProfileOption(
                        context,
                        icon: Icons.add_circle_outline,
                        title: 'Create New Gig',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const GigWizardScreen())),
                      ),
                      _buildProfileOption(
                        context,
                        icon: Icons.handshake_outlined,
                        title: 'My Gigs',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ManageGigsScreen())),
                      ),
                    ],
                    ...
                    if (role == 'creator') ...[
                      ...
                      _buildProfileOption(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CreatorSocialAccountsScreen())),
                      ),
                      _buildProfileOption(
                        context,
                        icon: Icons.inventory_2_outlined,
                        title: 'My Packages',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CreatorPackagesScreen())),
                      ),
                      _buildProfileOption(
                        context,
                        icon: Icons.photo_library_outlined,
                        title: 'Portfolio Gallery',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CreatorGalleryScreen())),
                      ),
                    ],
                    ...
                    if (role == 'creator' || role == 'brand') ...[
                      ...
                      _buildProfileOption(
                        ...
                        icon: Icons.handshake_outlined,
                        title: 'My Projects',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CollaborationsScreen())),
                      ),
                    ],
                    ...
                    if (role == 'brand') ...[
                      _buildProfileOption(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const BrandDashboardScreen())),
                      ),
                      _buildProfileOption(
                        context,
                        icon: Icons.campaign_outlined,
                        title: 'My Campaigns',
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const BrandCampaignsScreen())),
                      ),
                      _buildProfileOption(
                        context,
                        icon: Icons.handshake_outlined,
                      ...
                      _buildProfileOption(
                        ...
                        onTap: () {}, // Future: Shortlist feature
                      ),
                    ],
                    if (role != 'professional' && role != 'creator' && role != 'brand')
                      _buildProfileOption(
                        context,
  ...
  Widget _buildProfileHeader(BuildContext context, String name, String roleName) {
    ...
    if (role == 'brand') {
      avatar = _userData?['brand_profile']?['logo_url'];
    } else if (role == 'creator') {
      avatar = _userData?['creator_profile']?['avatar_url'];
    }
    
    // Fallback to user level avatar
    avatar ??= _userData?['avatar_url'];
    
    if (avatar != null && !avatar.startsWith('http')) {
      avatar = '${Env.apiUrl}$avatar';
    }
            ...
            Container(
              ...
              child: CircleAvatar(
                ...
                child: avatar == null || avatar.isEmpty
                    ? Icon(Icons.person, size: 48, color: isDark ? Colors.white24 : const Color(0xFF9CA3AF))
                    : null,
              ),
            ),
            Positioned(
  ...
  Widget _buildProfessionalInfoCard(BuildContext context, String role) {
    final Map<String, dynamic>? profile = role == 'creator' 
        ? (_userData?['creator_profile'] as Map<String, dynamic>?)
        : (_userData?['brand_profile'] as Map<String, dynamic>?);
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
      ...
      children: [
        Expanded(
          child: _buildMetricCard(
            context,
            (role == 'creator' || role == 'professional') ? 'Earning' : 'Spent',
            '₹0',
        ...
        Expanded(
          child: _buildMetricCard(
            context,
            (role == 'creator' || role == 'professional') ? 'Gigs' : 'Campaigns',
            '0',
            (role == 'creator' || role == 'professional') ? Icons.handshake_outlined : Icons.campaign_outlined,
            Colors.blue,
          ),
        ),
        const SizedBox(width: 12),
